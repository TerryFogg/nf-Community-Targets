...
# Setup the type of build to customise elements of the CLR
    ...
    if(RANDOM_NUMBER_GENERATOR)
        ...
        target_compile_definitions(nanoCLR PUBLIC -DNUMBER_I2C_BUSES=${NUMBER_I2C_BUSES})
    
# Common FileX definitions
     if(FILE_SYSTEM_SUPPORT)
              target_compile_definitions(nanoCLR PUBLIC -DFILE_SYSTEM_SUPPORT=TRUE)
     endif()
     if(FILE_SYSTEM_SD)
              target_compile_definitions(nanoCLR PUBLIC -DFILE_SYSTEM_SD=TRUE)
     endif()
     if(FILE_SYSTEM_FLASH)
              target_compile_definitions(nanoCLR PUBLIC -DFILE_SYSTEM_FLASH=TRUE)
     endif()
     if(FILE_SYSTEM_RAM)
              target_compile_definitions(nanoCLR PUBLIC -DFILE_SYSTEM_RAM=TRUE)
     endif()
