...
target_compile_options(nanoCLR PUBLIC $<$<COMPILE_LANGUAGE:C>:-mthumb -mcpu=cortex-m0 -fomit-frame-pointer>)
...
target_compile_options(nanoCLR PUBLIC $<$<COMPILE_LANGUAGE:CXX>:-mthumb -mcpu=cortex-m0 -fomit-frame-pointer>)
...
target_compile_options(nanoCLR PUBLIC $<$<COMPILE_LANGUAGE:ASM>:-mcpu=cortex-m0 -x assembler-with-cpp>)
...
target_link_options(nanoCLR PUBLIC "-T${CMAKE_SOURCE_DIR}/targets-community/ThreadX/${TARGET_VENDOR}/${TARGET_FAMILY}/${TARGET_BOARD}/Linker_script.ld")
set_target_properties(nanoCLR PROPERTIES LINK_DEPENDS "${CMAKE_SOURCE_DIR}/targets-community/ThreadX/${TARGET_VENDOR}/${TARGET_FAMILY}/${TARGET_BOARD}/Linker_script.ld")

target_link_options(nanoCLR PUBLIC "--specs=nosys.specs")
target_link_options(nanoCLR PUBLIC "-mthumb")
target_link_options(nanoCLR PUBLIC "-mcpu=cortex-m0")
