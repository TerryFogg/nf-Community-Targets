...
#
list(APPEND NF_INTERPRETER_COMMON_INCLUDES 
...
list(APPEND NF_INTERPRETER_COMMON_SOURCES
...
#src/PAL/COM/Sockets/ssl/MBedTLS - To be followed up
#src/PAL/COM/Sockets/ssl -To be followed up
#src/PAL/COM/Sockets - To be followed up
...
#src/PAL/LWIP - To be followed up
...
list(APPEND NF_INTERPRETER_GRAPHICS_SOURCES
            ...
            ${CMAKE_SOURCE_DIR}/targets-community/ThreadX/Common/nanoFramework.Graphics/Initialize_Graphics.cpp
