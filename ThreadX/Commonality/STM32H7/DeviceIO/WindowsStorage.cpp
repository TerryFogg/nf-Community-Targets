...
HRESULT Library_win_storage_native_Windows_Storage_StorageFile::RenameFileNative___VOID__STRING(
    CLR_RT_StackFrame &stack)
{
    (void)stack;
    return 1;
}
HRESULT Library_win_storage_native_Windows_Storage_StorageFile::
    GetFileFromPathNative___STATIC__WindowsStorageStorageFile__STRING__STRING(CLR_RT_StackFrame &stack)
{
    (void)stack;
    return 1;
}
