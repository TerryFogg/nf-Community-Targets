...
const BlockRange BlockRange1[] = {
    ...
    {BlockRange_BLOCKTYPE_DEPLOYMENT, &deployment_block_start, (uint32_t)(uint32_t *)&deployment_block_end},
...
MEMORY_MAPPED_NOR_BLOCK_CONFIG Device_BlockStorageConfig = {
    ...
    },
    {
        ...
        (uint32_t)(uint32_t *)&total_blocks,  // UINT32 CPU_MEMORY_CONFIG::SizeInBytes;
