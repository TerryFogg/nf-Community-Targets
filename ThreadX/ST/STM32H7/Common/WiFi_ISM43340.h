...
#define WIFI_READ_PACKET_SIZE                                                                                          \
    (WIFI_MAX_READ_PACKET_SIZE > WIFI_RX_BUFFER_SIZE ? WIFI_RX_BUFFER_SIZE : WIFI_MAX_READ_PACKET_SIZE)
...
#define WIFI_IS_CMDDATA_READY()                                                                                        \
    (HAL_GPIO_ReadPin(WIFI_CMD_DATA_READY_GPIO_Port, WIFI_CMD_DATA_READY_Pin) == GPIO_PIN_SET)
...
WIFI_StatusTypeDef WIFI_SendATCommand(
