...
{
    int GPIOPortByNumber = PORT_INDEX(devicePin.pinNameValue);
    uint32_t gpioPortPinNumber = PIN_INDEX(devicePin.pinNameValue);

    uint32_t FOLLOW_UP_AND_FIX = LL_GPIO_AF_9;
    ...
    switch (devicePin.CurrentFunction)
    {
        ...
        case DeviceRegistration::DevicePinFunction::I2C:
        {
            ...
            {
                LL_GPIO_SetAFPin_0_7(Port[GPIOPortByNumber], gpioPortPinNumber, FOLLOW_UP_AND_FIX);
            }
            if (gpioPortPinNumber >= 8)
            {
                LL_GPIO_SetAFPin_8_15(Port[GPIOPortByNumber], gpioPortPinNumber, FOLLOW_UP_AND_FIX);
            }
        ...
        case DeviceRegistration::DevicePinFunction::USART:
            LL_AHB4_GRP1_EnableClock(GpioPortClockEnable[GPIOPortByNumber]);
            GPIO_InitStruct.Alternate = FOLLOW_UP_AND_FIX;
...
I2cTransferStatus I2cIO::Dispose(CLR_INT32 I2C_deviceId)
{
    bool status = false;
    switch (I2C_deviceId)
    {
